# Florida HVAC Regulations Guide

A comprehensive reference for Florida HVAC licensing, permit requirements, building codes, and regulations. Written for homeowners hiring contractors and professionals navigating Florida's licensing system.
...
- Fines up to $10,000 for the contractor (and liability exposure for the homeowner)

## Contents

### Licensing

- [Florida HVAC License Types](docs/license-types.md) - CAC vs CMC vs RA licenses, scope of work, and requirements
- [How to Verify a Contractor's License](docs/verify-license.md) - Step-by-step guide using DBPR lookup tools
- [Continuing Education Requirements](docs/continuing-education.md) - CE hours, approved providers, and renewal cycles
...
- [HVAC Permit Violation Penalties](docs/hvac-permit-violation-penalties-florida.md) - The real cost of skipping permits: stop-work orders, doubled fees, insurance claim denials, DBPR fines, and license suspension for contractors
...
- [HVAC Warranty Guide for Florida Homeowners](docs/hvac-warranty-guide.md) - Manufacturer vs contractor warranties, registration, extended plans, Florida coastal corrosion, flood/hurricane coverage, and what voids coverage
...
- **[Florida HVAC Maintenance Requirements for Warranty Compliance](docs/maintenance-requirements-warranty.md)** — What Florida homeowners need to know to keep their AC warranty valid: the annual professional maintenance requirement manufacturers demand, what a warranty-compliant inspection must document, Florida-specific issues (coastal corrosion exclusions, registration deadlines, Manual J sizing), the records you must keep, homeowner responsibilities like filter changes and clearance maintenance, and how to challenge a denied warranty claim under Florida law. Essential reading before scheduling any [AC maintenance](https://ac-repair.today/services/ac-maintenance/).
...
- [Asbestos & HVAC Work in Florida](docs/asbestos-hvac-regulations.md) - Where asbestos is found in older HVAC systems, EPA NESHAP requirements, Florida DEP and local air management rules (Miami-Dade DERM, Broward, Palm Beach), contractor licensing distinctions, OSHA requirements for HVAC workers, and what homeowners need to know before starting work on pre-1980 equipment
...
| Topic | Key Fact |
|-------|----------|
| License required? | Yes - all HVAC work in Florida requires a licensed contractor |
| Minimum SEER (2026) | 15 SEER2 for split systems in South Florida (climate zones 1-2) |
| Permit required? | Yes for new installs, replacements, and major duct modifications |
| License lookup | [DBPR License Search](https://www.myfloridalicense.com/wl11.asp) |
| Complaint filing | [DBPR Complaint Form](https://www.myfloridalicense.com/intentions2.asp?chession=FLdbprGOC) |

## Florida Climate Zones

Florida spans climate zones 1 and 2 under IECC, with specific efficiency requirements:

- **Zone 1** (South Florida - Miami-Dade, Broward, Palm Beach, Monroe): Highest cooling loads, strictest efficiency standards
- **Zone 2** (Central/North Florida): Slightly lower cooling requirements but still demanding

## About

This guide is maintained by [AC Repair Today](https://ac-repair.today) - a licensed HVAC contractor serving South Florida (FL License CAC1824118). We created this resource to help homeowners understand the regulations that protect them and ensure quality HVAC work.

For professional AC repair, installation, and maintenance in Miami-Dade, Broward, and Palm Beach counties, visit [ac-repair.today](https://ac-repair.today).
